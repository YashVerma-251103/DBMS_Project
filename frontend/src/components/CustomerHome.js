...
// import Incidents from './customer_tab/Incidents';
...
const CustomerHome = () => {
  ...
  const sidebarItems = [
    { key: 'Facilities', label: 'Facilities', icon: <MdBusiness /> },
    { key: 'bookings', label: 'Bookings', icon: <MdEvent /> },
    // { key: 'incidents', label: 'Incidents', icon: <MdReportProblem /> },
    { key: 'profile', label: 'Profile', icon: <MdPerson /> }
  ];

  // Renders the active tab component based on state.
  ...
  // Change the active tab (also closes the mobile sidebar if open)
    ...
    <div className={`customer-dashboard ${sidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <div className="sidebar">
        <div className="sidebar-header">
          ...
          <button className="sidebar-close" onClick={() => setSidebarOpen(false)} style={{ display: 'none' }}>
            <FaTimes />
          </button>
        </div>
        <div className="sidebar-content">
          <ul>
            {sidebarItems.map(item => (
              ...
              >
                <span className="entity-icon">{item.icon}</span>
          ...
          <div className="sidebar-footer">
            <div className="profile-info">
              ...
              <div className="profile-details">
                <span className="profile-name">Customer User</span>
