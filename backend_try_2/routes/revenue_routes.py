...
# from dynamic_querry_generator.complex_queries.revenue_query import (
#     build_calculate_revenue,
# )
...
#     """
#     Endpoint to calculate the average revenue for a given facility and date range.
...
#     # Normalize query parameters to lower case
#     normalized_args = {k.lower(): v for k, v in request.args.items()}
#     print("Normalized args:", normalized_args)

#     # Extract parameters from the normalized query arguments
...
#     query = build_calculate_revenue(search_params)
